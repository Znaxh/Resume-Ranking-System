...
class TestAlgorithms(unittest.TestCase):
    ...
    def test_jaccard_similarity(self):
        ...
        # Option A: JaccardSimilarityAnalyzer keeps algorithm key "jaccard" for API compatibility
        # but implements BM25-style scoring; details use coverage / top_matching_terms, not
        # legacy matching_skills. See algorithms/similarity/jaccard_similarity.py docstring.
        ...
        self.assertTrue(
            'coverage_ratio' in details or 'top_matching_terms' in details,
            msg=f'Expected BM25/coverage details from jaccard analyzer, got: {list(details.keys())}',
        )
